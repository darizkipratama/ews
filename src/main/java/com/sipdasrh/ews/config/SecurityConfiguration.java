...
import com.sipdasrh.ews.security.*;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET,"/v3/**")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET,"/api/spas-arr-logs/get-sensor")).permitAll()
